...
taxi<-transform(taxi, year_pickup = as.numeric(year_pickup),month_pickup = as.numeric(month_pickup),
...
taxi<-transform(taxi, VendorID  = as.numeric(VendorID),passenger_count  = as.numeric(passenger_count),
...
taxi<-transform(taxi, year_dropoff = as.numeric(year_dropoff),month_dropoff = as.numeric(month_dropoff),
